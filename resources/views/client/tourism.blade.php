...
@section('content')
    ...
    <div class="hide" id="balikturista">
        ...
        <div class="container text-center baliktur" id="balikturismo" display="none">
         ...
         $(function () {
            $('#clock-b').countdown('2020/10/11').on('update.countdown', function(event) {
                var $this = $(this).html(event.strftime(''
                    ...
                    balikturista.style.display = 'none';
                }).on('stoped.countdown', function(event){
                    var countdown = document.getElementById("countdown2");
                    var balikturismo = document.getElementById('balikturista');
