    <div class="bg-primary">
        <div class="offset-md-2 col-md-8 offset-md-2 mt-4">
            <div class="row">
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-6 my-3">
                                <h5 class="text-light"> <strong> REPUBLIC OF THE PHILIPPINES </strong> </h5>
                                <h5 class="text-light">All content is in the public domain unless otherwise stated.</h5>
    ...
    {{-- <footer class="sticky-footer foot">
        <div class="container my-auto">
            ...
            <span class="text-light font-weight-bold"><h5>Copyright &copy; Your Website 2019</h5></span>
            </div>
        </div>
    </footer> --}}
