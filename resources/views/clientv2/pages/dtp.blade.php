    ...
    <div class="container-fluid pt-5 mt-5">
      <div class="row my-5">
        <div class="col-md-8 offset-md-2">
          <h5 class="text-justify">Pursuant<strong> to Section 2(a) of <i><a href="https://www.officialgazette.gov.ph/1991/10/10/republic-act-no-7160/" target="_blank">Republic Act (RA) No. 7160</a> </i>or the Local Government Code of 1991 (LGC)</strong>, the State shall provide for a more responsive and accountable local government structure instituted through a system of decentralization whereby local government units (LGUs) shall be given more powers, authority, responsibilities, and resources. The process of decentralization shall proceed from the National Government (NG) to the LGUs.</br></br>

            <strong>Section 3(d) of <i><a href="https://www.officialgazette.gov.ph/1991/10/10/republic-act-no-7160/" target="_blank">RA No. 7160</a></i></strong> further provides that the vesting of duty, responsibility, and accountability in LGUs shall be accompanied with provision for reasonably adequate resources to discharge their powers and effectively carry out their functions; hence, they shall have the power to create and broaden their own sources of revenue and the right to a just share in national taxes and an equitable share in the proceeds of the utilization and development of the national wealth within their respective areas.</br></br>

            In line with the implementation of the SC Ruling, <i><a href="https://www.officialgazette.gov.ph/2021/06/01/executive-order-no-138-s-2021/" target="_blank">Executive Order (EO) No. 138</a></i> orders the full devolution of functions, services, and facilities by the NG to the LGUs not later than the end of FY 2024. Except for those functions that shall be primarily and ultimately responsible and accountable for the provision of all basic services and facilities fully devoted to them, in accordance with the minimum standards for service delivery to be prescribed by the NG.</br></br>

            To support the transition to full devolution, Section 10 of <i><a href="https://www.officialgazette.gov.ph/2021/06/01/executive-order-no-138-s-2021/" target="_blank">Executive Order (EO) No. 138</a></i>, instructs all LGUs to formulate and prepare their Devolution Transition Plans (DTPs) to guide the transition in their full assumption of the devolved roles and responsibilities.
        </div>
      </div>
