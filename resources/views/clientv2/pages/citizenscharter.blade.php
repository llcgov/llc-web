                                                        ...
                                                        <div class="card-body">
                                                            <ul>
                                                                @foreach ($quart as $fdpdocs)
                                                                    <li>
                                                                      @php $specials = array(",", ".", " ", "-", "(", ")", "[", "]", "/", "'") @endphp
                                                                        <a href="" class="text-decoration-none" data-toggle="modal" data-target="#CITCHART{{ str_replace($specials, '', $fdpdocs->title)  }}"><h5 class="text-uppercase">{{ $fdpdocs->title }}</h5></a>
                                                                    </li>                          
                                                                    {{-- MODAL --}}
                                                                    <div class="modal fade bd-example-modal-xl" id="CITCHART{{ str_replace($specials, '', $fdpdocs->title) }}" tabindex="-1" role="dialog" aria-labelledby="{{ $fdpdocs->id }}" aria-hidden="true">
