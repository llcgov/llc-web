...
$(function(){
    ...
    $(document.body).on("click", '.addline', function(){
        ...
        if(i == 0){
            ...
            ba.find("#line"+ parseInt(i-parseInt(1))).addClass("fa-minus");
            ba.find("#line"+ parseInt(i-parseInt(1))).removeClass("fa-plus");

            ba.find("#btnline"+ parseInt(i-parseInt(1))).addClass("removeline");
            ba.find("#btnline"+ parseInt(i-parseInt(1))).removeClass("addline");
        }
